...
//    $userfio = 'пользователь не авторизован';
...
//        $response = Requests::get('http://www.rosescrm.brottys.ru/account/manager_fio', $headers);
//        $myrow = json_decode($response->body, true);
//        $userfio = $myrow['lastName'].' '.$myrow['firstName'].' '.$myrow['secondName'];
//    }
